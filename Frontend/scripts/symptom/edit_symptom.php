...
$url = $apiurl.'/Backend/API/Symptom/Edit.php';

$_POST['symptomID'] = $_POST['input'];
unset($_POST['input']);
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('edit_symptom', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('edit_symptom', 'UNKNOWN');
