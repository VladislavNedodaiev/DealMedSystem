...
$url = $apiurl.'/Backend/API/Room/Delete.php';

$_POST['roomID'] = $_POST['input'];
unset($_POST['input']);
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('remove_room', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('remove_room', 'UNKNOWN');
