...
if (!isset($_POST['roomFromID']) || !isset($_SESSION['profile'])) {
...
$url = $apiurl.'/Backend/API/Connection/Add.php';
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('add_connection', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('add_connection', 'UNKNOWN');
