...
$url = $apiurl.'/Backend/API/Specialization/Add.php';
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('add_specialization', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('add_specialization', 'UNKNOWN');
