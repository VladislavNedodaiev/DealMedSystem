...
$url = $apiurl.'/Backend/API/Client/Delete.php';

$_POST['clientID'] = $_POST['input'];
unset($_POST['input']);
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('remove_client', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('remove_client', 'UNKNOWN');
