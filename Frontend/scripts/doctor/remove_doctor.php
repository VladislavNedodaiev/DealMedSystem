...
$url = $apiurl.'/Backend/API/Doctor/Delete.php';

$_POST['doctorID'] = $_POST['input'];
unset($_POST['input']);
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('remove_doctor', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('remove_doctor', 'UNKNOWN');
