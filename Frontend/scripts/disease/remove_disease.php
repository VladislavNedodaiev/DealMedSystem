...
$url = $apiurl.'/Backend/API/Disease/Delete.php';

$_POST['diseaseID'] = $_POST['input'];
unset($_POST['input']);
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('remove_disease', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('remove_disease', 'UNKNOWN');
