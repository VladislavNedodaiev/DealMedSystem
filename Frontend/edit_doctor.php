...
<article class="card-body mx-auto">
	<div class="card" style="width: 70rem;">
		<form action="scripts/doctor/save_doctor_profile.php" method="POST">
		<div class="card-header">
			<div class="row">
				...
				<div class="col text-right my-auto">
					...
					<a href="doctor.php"><button type="button" class="btn btn-secondary"><?php echo getLocalString('edit_profile', 'cancel_button_text'); ?></button></a>
			...
			<div class="row">
				...
				<div class="col">
					<div class="row m-2 border-bottom">
						...
						<div class="col p-2"><h4><input type="text" class="form-control" id="first_name" name="first_name" placeholder="<?php echo getLocalString('edit_profile', 'first_name_placeholder'); ?>" value="<?php echo $doctor->firstName; ?>"></h4></div>
					</div>
					<div class="row m-2 border-bottom">
						<div class="col-5 my-auto"><h4 class = "text-muted"><?php echo getLocalString('doctor_profile', 'second_name'); ?>: </h4></div>
						<div class="col p-2"><h4><input type="text" class="form-control" id="second_name" name="second_name" placeholder="<?php echo getLocalString('edit_profile', 'second_name_placeholder'); ?>" value="<?php echo $doctor->secondName; ?>"></h4></div>
					</div>
					<div class="row m-2 border-bottom">
						<div class="col-5 my-auto"><h4 class = "text-muted"><?php echo getLocalString('doctor_profile', 'third_name'); ?>: </h4></div>
						<div class="col p-2"><h4><input type="text" class="form-control" id="third_name" name="third_name" placeholder="<?php echo getLocalString('edit_profile', 'third_name_placeholder'); ?>" value="<?php echo $doctor->thirdName; ?>"></h4></div>
					</div>
					<div class="row m-2 border-bottom">
